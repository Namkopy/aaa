...
public class dlgCourseSemester extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel8.setPreferredSize(new java.awt.Dimension(1112, 331));
        ...
        jtblCS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Course", "Subject", "Semester", "Sessions"
            }
        ) {
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addComponent(lblAlert3, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE))
                    .addGroup(jPanel8Layout.createSequentialGroup()
    ...
    private void btnAdd2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd2ActionPerformed
        ...
        getSubjectID();
        getSujectIDToLabel();
               String sql = "insert into tblSubjectSemester(CourseID,SubjectID,SemesterID,StudySessions,Active) values('"+Integer.parseInt(lblCourseID.getText())+"','"+lblSubjectID.getText()+"','"+lblSemesterID.getText()+"','"+Integer.parseInt(lblSession.getText())+"',1)";
        try {
            ...
            String st[]={Course,Sub,Semester,Sessions};
            modeTbl.addRow(st);
